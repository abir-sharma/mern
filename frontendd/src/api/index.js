...
export const createPosts=(data)=>axios.post("/api/v1/post/new",data)
export const fetchPosts=(search)=>axios.get(`/api/v1/posts${search}`)
export const deletePost=(id)=>axios.delete(`/api/v1/post/${id}`)
export const editPosts=(id,data)=>axios.put(`/api/v1/post/${id}`,data)
export const getPostsDetails=(id)=>axios.get(`/api/v1/post/${id}`)

export const register=(data)=>axios.post("/api/v1/register",data)
export const loginApi=(data)=>axios.post("/api/v1/login",data)
export const logout=()=>axios.get("/api/v1/logout")
export const editUser=(data)=>axios.put("/api/v1/me",data)
export const deleteUser=()=>axios.delete(`/api/v1/me`)
export const updatePassword=(data)=>axios.put("/api/v1/password/reset",data)
export const userDetails=()=>axios.get("/api/v1/me")
...
// export const createPosts=(data)=>axios.post("https://blog-api-96d1.onrender.com/api/v1/post/new",data)
